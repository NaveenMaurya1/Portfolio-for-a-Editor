...
export default function ImageCarousel({ onVideoChange }) {
    const content = [
        ...
        {
            id: 3,
            image: "https://res.cloudinary.com/zz6gfdix/image/upload/v1789908459/image_3.gif",
            video: "https://res.cloudinary.com/zz6gfdix/video/upload/v1789926817/IMG_6226.mp4",
            // title: "HIGHEST PEAK",
            category: "NARRATIVE",
            description: "A travell story , edited for a client",
        },
        {
            id: 4,
            image: "https://res.cloudinary.com/zz6gfdix/image/upload/v1789810376/samples/landscapes/beach-boat.jpg",
